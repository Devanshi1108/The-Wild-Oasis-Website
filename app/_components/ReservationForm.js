...
function ReservationForm({ cabin, user }) {
  ...
  const newBooking = { startDate, endDate, numNights, cabinPrice, cabinId };

  const createReservationActionBind = createReservationAction.bind(
    null,
    newBooking
  );
  return (
    <div className="scale-[1.01]">
      ...
      <form
        action={async (formData) => {
          createReservationActionBind(formData);
          resetRange();
        }}
